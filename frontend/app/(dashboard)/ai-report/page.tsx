    ...
    <div className="flex flex-col items-center justify-center min-h-[80vh] px-4 overflow-hidden relative">
      ...
      <div className="text-center max-w-2xl space-y-6">
        ...
        <p className="text-muted-foreground text-sm md:text-base font-medium max-w-md mx-auto leading-relaxed">
          Unlock the power of machine learning to identify patterns, mitigate
          risk, and optimize your trading edge.
        </p>
      </div>
        ...
        {[
          {
            ...
            desc: "Automated identification of complex chart structures.",
          },
          {
            icon: Target,
            title: "Edge Analysis",
            desc: "Statistical validation of your trading setup efficiency.",
          },
          {
            icon: LineChart,
            title: "Risk Prediction",
            desc: "ML-driven drawdown forecasting and risk management.",
          },
        ].map((feature, i) => (
          <Card
            key={i}
              ...
              {isSuccess ? (
                <div className="py-12 flex flex-col items-center justify-center text-center space-y-4">
                  ...
                  <p className="text-sm text-muted-foreground font-medium uppercase tracking-tighter italic">
                    We'll notify you when the AI engine is ready for deployment.
                  </p>
                </div>
              ) : (
                <>
                  <DialogHeader className="space-y-3">
                    <DialogTitle className="text-2xl font-black uppercase tracking-tighter flex items-center gap-2">
                      ...
                      Join <span className="text-primary italic">AI</span>{" "}
                      Waitlist
                    </DialogTitle>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5 pt-4">
                    ...
                    <div className="space-y-2">
                      <Label
                        ...
                        className="text-[10px] font-black uppercase tracking-widest flex items-center gap-1.5 opacity-60"
                      >
                        <Lightbulb className="w-3 h-3 text-primary" /> Primary
                        Interest
                      </Label>
