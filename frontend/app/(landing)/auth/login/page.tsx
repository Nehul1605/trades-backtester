...
import { TrendingUp, BarChart3, Radio, Shield, Loader2, Eye, EyeOff } from "lucide-react";
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  <Input
                    ...
                    className="bg-background/60 border-border/60 text-xs h-11 rounded-xl pr-10"
                  />
                  <button
                    type="button"
